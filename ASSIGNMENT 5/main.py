...
# ── Day 6 — Q4: Search the Orders List ────────────────────────────
...
# ── Day 6 — Q5: Sort Products by Category Then Price ──────────────
@app.get('/products/sort-by-category')
def sort_by_category():
    # Sorts first by category (A-Z), then by price (ascending)
    result = sorted(products, key=lambda p: (p['category'], p['price']))
    return {'products': result, 'total': len(result)}

# ── Day 6 — Q6: Search + Sort + Paginate in One Endpoint ──────────
...
# ── Day 6 — BONUS: Paginate the Orders List ───────────────────────
@app.get('/orders/page')
